  ...
  getSummary() {
    ...
    return {
      ...
      memory: {
        current: {
          rss:
            this.metrics.memory.currentMemory?.rss != null
              ? (this.metrics.memory.currentMemory.rss / 1024 / 1024).toFixed(2)
              : '0.00',
          heapUsed:
            this.metrics.memory.currentMemory?.heapUsed != null
              ? (this.metrics.memory.currentMemory.heapUsed / 1024 / 1024).toFixed(2)
              : '0.00',
        },
        peak: {
          rss:
            this.metrics.memory.peakMemory?.rss != null
              ? (this.metrics.memory.peakMemory.rss / 1024 / 1024).toFixed(2)
              : '0.00',
          heapUsed:
            this.metrics.memory.peakMemory?.heapUsed != null
              ? (this.metrics.memory.peakMemory.heapUsed / 1024 / 1024).toFixed(2)
              : '0.00',
        },
        growth: {
          rss: memoryGrowth?.rss != null ? (memoryGrowth.rss / 1024 / 1024).toFixed(2) : '0.00',
          heapUsed:
            memoryGrowth?.heapUsed != null
              ? (memoryGrowth.heapUsed / 1024 / 1024).toFixed(2)
              : '0.00',
        },
      },
    };
